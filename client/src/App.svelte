        ...
        >
            <div class="container max-w-6xl px-6 py-20 mx-auto">
                ...
                <div class="relative text-gray-200">
                    <div
                        class="grid gap-1 pb-20 uppercase sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 sm:gap-6"
                    >
                        <div
                            on:click={() => {
                                currentComponent = "Feed";
                            }}
                            class="flex items-center gap-5 px-2 py-2 mt-5 transition bg-indigo-900 rounded-lg shadow-xl cursor-pointer group bg-opacity-40 ring-2 ring-offset-2 ring-offset-indigo-800 ring-indigo-700 hover:bg-indigo-900 hover:bg-opacity-100"
                        >
                            <svg
                                class="w-9"
                                fill="currentColor"
